...
EMAIL_HOST_USER = os.getenv('EMAIL_HOST_USER', 'email@email.com') # Substitua pelo e-mail real que enviará os avisos
EMAIL_HOST_PASSWORD = os.getenv('EMAIL_HOST_PASSWORD', 'senha#senha') # Substitua pela senha real do e-mail (ou senha de app, se usar autenticação em duas etapas)
